...
class PacketDetailsTab(QWidget):
    ...
    def populate_protocol_tree(self, details):
        ...
        basic_item.setFont(0, QFont('Segoe UI', 16, QFont.Bold))
        ...
        protocol_fields = [
            ...
            ('TCP', ['src_port', 'dst_port', 'tcp_seq', 'tcp_ack', 'tcp_dataofs', 'tcp_reserved', 'tcp_flags', 'tcp_flags_raw', 'tcp_window', 'tcp_chksum', 'tcp_urgptr', 'tcp_options']),
            ('UDP', ['src_port', 'dst_port', 'udp_len', 'udp_chksum']),
    ...
    def show_packet_details(self, details):
        ...
        # Populate each protocol tab
        first_present = None
        for proto, fields in protocol_fields.items():
            ...
            # Track the first protocol with data
            if field_dict and first_present is None and len(field_dict) > len(basic_fields):
                first_present = proto
        ...
        # Switch to the first present protocol's tab or tree view if none
        if first_present:
